...
Параметры прямой в функциональных координатах: `r paste("ln(-k) =", round(log(-gmp12_alpha), 2),"; -k =", gmp12_alpha, "; b =", gmp12_beta)`.
...
Полученные параметры `r paste("-k =", gmp12_2_alpha, "; b =", gmp12_2_beta)` вернём обратно в модель Гомперца для построения теоретической кривой зависимости относительно реальных данных. Покажем на графике истинные значения заболеваемости без первой "волны" и теоретически полученную зависимость по дифференциальной модели.
